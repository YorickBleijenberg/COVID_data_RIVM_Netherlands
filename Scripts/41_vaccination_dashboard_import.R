...
long.est.all <- locale_dat$vaccine_administered_total

vac.given.filename <- paste0("data/temp.csv")
write.csv2(long.est.all, file = vac.given.filename, row.names = F)
...
estimated.given.ggd <- locale_dat$vaccine_administered_ggd$values
...
vaccins.registred.ggd   <- as.integer(locale_dat$vaccine_administered_ggd$last_value$estimated)
...
janssen.given <- (janssen.given %>% filter(date == today-1 ))
...
ggplot(new.vacc.df.work, aes(x=weekbegin, y=new , fill = factor(week_day, levels=c("Sunday","Saturday","Friday","Thursday", "Wednesday", "Tuesday","Monday"))))+
  ...
  annotate("rect", xmin = as.Date("2021-05-15"), xmax =as.Date("2021-05-21"), ymin =0, ymax = 1026596, color = "black",fill = "gray", alpha = 0.6)+
 # annotate("rect", xmin = as.Date("2021-05-15"), xmax =as.Date("2021-05-21"), ymin =1045985, ymax = 1025011, color = "black",fill = "red", alpha = 0.6)+ # week 20 - 23th
  annotate("rect", xmin = as.Date("2021-05-15"), xmax =as.Date("2021-05-21"), ymin =1025011, ymax = 1030054, color = "black",fill = "red", alpha = 0.6)+ # week 20 - 23th
  annotate("rect", xmin = as.Date("2021-05-15"), xmax =as.Date("2021-05-21"), ymin =1026596, ymax = 1025011, color = "black",fill = "red", alpha = 0.6)+ # week 20 - 23th
  
    
  annotate("rect", xmin = as.Date("2021-05-22"), xmax =as.Date("2021-05-28"), ymin =0, ymax = 995040, color = "black",fill = "gray", alpha = 0.6)+ #week 20 - 30th
  ...
  annotate("rect", xmin = as.Date("2021-05-22"), xmax =as.Date("2021-05-28"), ymin =995040, ymax = 1062193, color = "black",fill = "red", alpha = 0.6)+ #week 20 - 30th
  annotate("rect", xmin = as.Date("2021-05-22"), xmax =as.Date("2021-05-28"), ymin =995040, ymax = 1011335, color = "black",fill = "green", alpha = 0.6)+ #week 20 - 30th
  
  annotate("rect", xmin = as.Date("2021-05-29"), xmax =as.Date("2021-06-04"), ymin =0, ymax = 1013388, color = "black",fill = "gray", alpha = 0.6)+ #week 21 - 6th
  annotate("rect", xmin = as.Date("2021-05-29"), xmax =as.Date("2021-06-04"), ymin =1013388, ymax = 1126586, color = "black",fill = "red", alpha = 0.6)+ #week 21 - 6th
  annotate("rect", xmin = as.Date("2021-05-29"), xmax =as.Date("2021-06-04"), ymin =1013388, ymax = 1065035, color = "black",fill = "green", alpha = 0.6)+ #week 21 - 6th

  annotate("rect", xmin = as.Date("2021-06-05"), xmax =as.Date("2021-06-11"), ymin =0, ymax = 1413938, color = "black",fill = "gray", alpha = 0.6) +   # week 22  - 13th
  annotate("rect", xmin = as.Date("2021-06-05"), xmax =as.Date("2021-06-11"), ymin =1413938, ymax = 1417160, color = "black",fill = "red", alpha = 0.6) +   # week 22  - 13th
  annotate("rect", xmin = as.Date("2021-06-05"), xmax =as.Date("2021-06-11"), ymin =1413938, ymax = 1560209, color = "black",fill = "green", alpha = 0.6)+
  
  annotate("rect", xmin = as.Date("2021-06-12"), xmax =as.Date("2021-06-18"), ymin =0, ymax = 1448907, color = "black",fill = "gray", alpha = 0.6)+    # week 23 - 20th
  annotate("rect", xmin = as.Date("2021-06-12"), xmax =as.Date("2021-06-18"), ymin =1448907, ymax = 1648386, color = "black",fill = "red", alpha = 0.6)+
  annotate("rect", xmin = as.Date("2021-06-12"), xmax =as.Date("2021-06-18"), ymin =1448907, ymax = 1425962, color = "black",fill = "red", alpha = 0.6)+
  annotate("rect", xmin = as.Date("2021-06-12"), xmax =as.Date("2021-06-18"), ymin =1425962, ymax = 1495057, color = "black",fill = "green", alpha = 0.6)+
  annotate("rect", xmin = as.Date("2021-06-12"), xmax =as.Date("2021-06-18"), ymin =1429026, ymax = 1495057, color = "black",fill = "red", alpha = 0.6)+
  
  annotate("rect", xmin = as.Date("2021-06-19"), xmax =as.Date("2021-06-25"), ymin =0, ymax = 1425962, color = "black",fill = "gray", alpha = 0.6)+    # week 24 - 27
  annotate("rect", xmin = as.Date("2021-06-19"), xmax =as.Date("2021-06-25"), ymin =1325061, ymax = 1425962, color = "black",fill = "gray", alpha = 0.6)+
  annotate("rect", xmin = as.Date("2021-06-19"), xmax =as.Date("2021-06-25"), ymin =1325061, ymax = 1464491, color = "black",fill = "green", alpha = 0.6)+
  annotate("rect", xmin = as.Date("2021-06-19"), xmax =as.Date("2021-06-25"), ymin =1464491, ymax = 1482653, color = "black",fill = "green", alpha = 0.6)+
  
  annotate("rect", xmin = as.Date("2021-06-26"), xmax =as.Date("2021-07-02"), ymin =0, ymax = 1325061, color = "black",fill = "gray", alpha = 0.6)+     # week 25 - 4th
  annotate("rect", xmin = as.Date("2021-06-26"), xmax =as.Date("2021-07-02"), ymin =1325061, ymax = 1520605, color = "black",fill = "green", alpha = 0.6)+
  annotate("rect", xmin = as.Date("2021-06-26"), xmax =as.Date("2021-07-02"), ymin =1520605, ymax = 1530637, color = "black",fill = "green", alpha = 0.6)+
  
  annotate("rect", xmin = as.Date("2021-07-03"), xmax =as.Date("2021-07-09"), ymin =0, ymax = 1261144, color = "black",fill = "gray", alpha = 0.6)+   # week 26 - 11 th
  annotate("rect", xmin = as.Date("2021-07-03"), xmax =as.Date("2021-07-09"), ymin =1261144, ymax = 1280417, color = "black",fill = "red", alpha = 0.6)+   # week 26 - 11 th
  annotate("rect", xmin = as.Date("2021-07-03"), xmax =as.Date("2021-07-09"), ymin =1261144, ymax = 1456315, color = "black",fill = "green", alpha = 0.6)+   # week 26 - 11 th
  
  annotate("rect", xmin = as.Date("2021-07-10"), xmax =as.Date("2021-07-16"), ymin =0, ymax = 1250562, color = "black",fill = "gray", alpha = 0.6)+   # week 27 - 18 th

  
  
  geom_bar(stat='identity', color="black")+
  
  scale_y_continuous(limits = c(0, 1700000), breaks = c(200000, 400000, 600000, 800000,1000000,1250000, 1500000, 1750000),
