...
ggplot(Merged_data_short)+
 ...
 # geom_line(data=df.predict.kerst, aes(x=Date, y=MACases_2), size = 0.6, color = "black")+ 
  ...
  annotate("text", x = as.Date("2020-11-23"), y = 4700,  label = "Waakzaam tijdens kerst", size=5,angle=-50, color = "black",face = "bold", hjust ="left")+
...
#  annotate("text", x = as.Date("2020-11-06"), y = 6000,  label = "halvering elke 7 dagen", size=5,angle=-80, color = "black",face = "bold", hjust ="left")+
  annotate("text", x = as.Date("2020-11-23"), y = 4700,  label = "Waakzaam tijdens kerst", size=5,angle=-50, color = "#F5F5F5",face = "bold", hjust ="left")+
