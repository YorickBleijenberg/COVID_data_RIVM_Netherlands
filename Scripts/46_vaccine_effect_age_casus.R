...
old.casus.age <- casus.working<-count(old.casus,Agegroup)
new.casus.age <- casus.working<-count(new.casus,Agegroup)
...
cassus.age.spread.base


File_date_5 <- paste0("data/_casus_daily_age_dif.csv")
