...
pos.rate.vr <- pos.rate[ -c(1,3,4,8,11)]
colnames(pos.rate.vr) = c("week", "cases", "perc_pos","tested", "vregio", "inwoners")
...
ggplot(pos.rate.nl, aes(p.rate, vdphd, colour=date))+
  ...
  annotate("rect", xmin = 4, xmax = 20, ymin = 0, ymax = 25,color = "black", fill = "orange", alpha = 0.5)+
  
  annotate("rect", xmin = 0, xmax =4, ymin = 25, ymax = 50, color = "black", fill = "orange", alpha = 0.5)+
  annotate("rect", xmin = 4, xmax =20, ymin = 25, ymax = 50,color = "black", fill = "orange", alpha = 0.9)+
  ...
  ggsave("data/60_ECDC-1.png",width=16, height = 9)  
