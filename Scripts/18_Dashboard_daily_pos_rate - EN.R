...
dates_vline_mondays <- as.Date(c("2020-08-10","2020-08-17","2020-08-24","2020-08-31","2020-09-07",
                                 ...
                                 "2021-02-01","2021-02-08","2021-02-15","2021-03-21"))
...
values.subtitle <- paste0("Date last datapoint: ",date.last.value, "    ---    Number of tests: ",last.tests.value,"\n",
                          "Percentage positive: ", last.pos.value,  "%    ---   7-day average percentage: ",last.pos_ma.value, "%")
...
ggplot(data = tested_daily,)+  
  ...
  scale_x_date(date_breaks = "2 week", 
               ...
               limits = as.Date(c("2020-06-03", "2021-07-09")))+
...
ggsave("data/22_tests_ggd_daily_EN.png",width=16, height = 9)
