...
christ.death <- christ.death[christ.death$Date_statistics_type == 'DOO',]


christ.death <- christ.death[christ.death$Date_statistics>"2021-12-09"&christ.death$Date_statistics<="2021-12-11",]  #date of event plus 5-7 days
...
ggplot(placeholder)+
  ...
  xlab("")+ 
  ylab("")+
  labs(title = "Sint doden",
       subtitle = "Datum eerste klachten tussen 9 december en 11 december",
...
ggsave("data/88_sint_2021_death.png",width=16, height = 9)  
