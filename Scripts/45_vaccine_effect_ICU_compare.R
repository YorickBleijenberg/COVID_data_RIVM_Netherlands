...
maxClinFive  <-  max(vacc.effect.age.ICU$MA.fifty.Change, na.rm = TRUE)
maxClinSix   <-  max(vacc.effect.age.ICU$MA.sixty.Change, na.rm = TRUE)
...
ggplot(relative.table.clinic.long, aes(x=Datum, y= value, color = factor(key, levels=c("MA.young.Change.relative","MA.fifty.Change.relative","MA.sixty.Change.relative", "MA.old.Change.relative", "MA.old80.Change.relative"))))+
  geom_line( size=3 )+
...
ggplot(abs.table.clinic.long, aes(x=Datum, y= value, color = factor(key, levels=c("MA.young.Change","MA.fifty.Change","MA.sixty.Change", "MA.old.Change", "MA.old80.Change"))))+
  geom_line( size=3 )+
