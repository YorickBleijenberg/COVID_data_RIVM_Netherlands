...
persco.df=data.frame(date=as.Date(c("2020-09-19", "2020-09-29", "2020-10-14",
                     ...
                     event=c("|Kroeg uurtje eerder dicht", "|We gaan voor\nR=0,9","|Semi-lockdown\n(0.75-0.99)",
                             ...
                             "| Avondklok 22u"),
                     yas=c(1.01, 0.80, 0.7, 0.55,0.75,0.7,0.75, 0.85, 0.9, 0.85)
) 
...
persco.df=data.frame(date=as.Date(c("2020-09-19", "2020-09-29", "2020-10-14", "2020-11-04","2020-11-18","2020-12-14", "2021-01-23", "2021-02-08", "2021-03-03")), 
                        event=c("|Kroeg uurtje eerder dicht", "|We gaan voor\nR=0,9","|Semi-lockdown\n(0.75-0.99)", "|verzwaring\nsemi-lockdown\n(0.72-0.91)", "|Einde verzwaring",
                                "| lockdown, R=0.8","| Avondklok & \nbezoekbeperking", "| Basisscholen open", "| Kappers open"),
                     yas=c(1.01, 0.85, 0.75, 0.72,0.75,0.75,0.75, 0.9, 0.95)
                     )

persco.dates <- data.frame(date=as.Date(c("2020-09-19", "2020-09-29", "2020-10-14", "2020-11-04","2020-11-18", "2020-12-14", "2021-01-25", "2021-02-08","2021-03-03")),
                                     event=c("19 sep", "29 sep", "14 okt", "5 nov","18 nov", "14 Dec", "23 Jan", "8 Feb", "3 Maa"))
...
ggplot(last.date.old.wide.2, aes(x=Date, y=Rt_avg, group = 1))+
  ...
  labs(title = "Reproductiegetal, RIVM model 27 april",
       subtitle = "Met de beleidsdoelen voor de R", #  OMT: 'Een lagere R is beter'",
       caption = paste("Bron: RIVM | Plot: @YorickB ",Sys.Date()))+
