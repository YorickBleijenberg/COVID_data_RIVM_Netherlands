...
ggsave("data/plots/11_20.21_compare_cases.png",width=16, height = 9)
...
ggsave("data/plots/11_20.21_compare_dead.png",width=16, height = 9)
...
ggplot(LCPS.compare, aes(x=rawDate, y = total.occupation))+
  ...
  ggsave("data/plots/11_20.21_compare_hosp.occu.png",width=16, height = 9)
...
ggplot(NICE.compare, aes(x=rawDate, y = total.intake.ma))+
  ...
  ggsave("data/plots/11_20.21_compare_hosp.new.png",width=16, height = 9)
...
tweet.year.compare.tweet <- sprintf(tweet.year.compare.tweet,
...
Encoding(tweet.year.compare.tweet) <- "UTF-8"

post_tweet(tweet.year.compare.tweet,  media = c("data/plots/11_20.21_compare_cases.png",
                                           "data/plots/11_20.21_compare_dead.png",
                                           "data/plots/11_20.21_compare_hosp.occu.png",
                                           "data/plots/11_20.21_compare_hosp.new.png"
